...
/**
 * La classe SourceNRZ représente une source analogique utilisant le codage
 * Non-Return-to-Zero (NRZ). Elle étend la classe SourceAnalogique et implémente
 * la méthode de filtrage spécifique pour le codage NRZ.
 */
public class SourceNRZ extends SourceAnalogique {
	...
	/**
	 * Construit un objet SourceNRZ avec des paramètres de message générés
	 * aléatoirement.
	 *
	 * @param nbEchantillon Le nombre d'échantillons par symbole.
	 * @param amp_min       L'amplitude minimale.
	...
	/**
	 * Implémente la méthode de filtrage spécifique pour le codage NRZ. Cette
